<template>
  <view class="tabs-wrapper">
    ...
    <div class="tab-content">
      <TabBusinessSituation v-if="activeTabId === 1"></TabBusinessSituation>
      <TabSubsidies v-if="activeTabId === 2"></TabSubsidies>
      <TabCompensation v-if="activeTabId === 3"></TabCompensation>
    </div>
  </view>
</template>
