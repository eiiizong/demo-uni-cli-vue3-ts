  ...
  <div class="demo-toast">
    <demo-block title="文字提示" padding>
      <yh-button
        ...
        >文字提示</yh-button
      >
      <yh-button type="primary" @click="showLongToast = true"
        >长文字提示</yh-button
      >
    </demo-block>
    ...
    <demo-block title="加载提示" padding>
      <yh-button
        type="primary"
        @click="showLoadingToast = true"
        custom-style="margin-right:20rpx;"
        >加载提示</yh-button
      >
      <yh-button type="primary" @click="showCustomLoadingToast = true"
        >自定义加载图标</yh-button
      >
    </demo-block>
    ...
    <demo-block title="成功/失败提示" padding>
      <yh-button
        ...
        >成功提示</yh-button
      >
      <yh-button type="danger" @click="showFailToast = true"
        >失败提示</yh-button
      >
    </demo-block>

    <demo-block title="动态更新提示" padding>
      <yh-button type="primary" @click="onShowCustomizedToast"
        >动态更新提示</yh-button
      >
    </demo-block>
    ...
    <yh-toast
      ...
      @close="showLongToast = false"
    ></yh-toast>
    <yh-toast
      type="loading"
      :show="showLoadingToast"
      message="加载中..."
      @close="showLoadingToast = false"
    ></yh-toast>
    <yh-toast
      type="loading"
