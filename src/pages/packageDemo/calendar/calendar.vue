<template>
  <div class="demo-calendar">
    <demo-block title="基础用法">
      <div class="cells">
        ...
        >
          ...
          <YhIcon name="arrow-right" color="#969799"></YhIcon>
        </div>
        <div
          class="cell"
          @click="show"
        ...
        <div class="cell" @click="show" data-type="range" data-id="selectRange">
    ...
    <demo-block title="自定义日历">
      <div class="cells">
        <div class="cell" @click="show" data-type="range" data-id="customColor">
        ...
        <div class="cell" @click="show" data-type="range" data-id="maxRange">
