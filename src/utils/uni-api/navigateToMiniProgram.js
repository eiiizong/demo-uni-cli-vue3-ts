 ...
 * @param {object} [extraData=null] - 需要传递给目标小程序的数据，目标小程序可在 App.vue 的 onLaunch或onShow 中获取到这份数据。默认`null`。
 * @param {string} [envVersion='release'] - 要打开的小程序版本，默认值`release`。有效值： develop（开发版），trial（体验版），release（正式版）。仅在当前小程序为开发版或体验版时此参数有效。如果当前小程序是正式版，则打开的小程序必定是正式版。
 * @returns {Promise}
