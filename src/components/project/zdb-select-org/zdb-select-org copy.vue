            ...
            <swiper-item class="swiper-item">
              <view class="swiper-item-content">
                ...
                <scroll-view
                  ...
                  v-if="
                    requestStatusArr[swiperIndex] &&
                    requestStatusArr[swiperIndex].isHaveData
                  "
                >
                  <block
                    v-for="(
                ...
                <div
                  ...
                  v-if="
                    requestStatusArr[swiperIndex] &&
                    requestStatusArr[swiperIndex].isLoading
                  "
                >
                ...
                <div
                  ...
                  v-if="
                    requestStatusArr[swiperIndex] &&
                    requestStatusArr[swiperIndex].isError
                  "
                >
...
export default {
  ...
  methods: {
    ...
    updateSelectedAddressArr(newObj, index) {
      ...
      if (
        this.subsidyProjectAuditChannel == '2' &&
        config.areaCode === '510500'
      ) {
        level = 2
      }
    ...
    async initAddress(address) {
      ...
      const requestSystemType = this.requestSystemType
      let level = this.level
      const { areaCode, FFAddressRequestParams, SPAddressRequestParams } =
        config
      // 泸州特殊处理，学校查询最多只需要选中第二级即可
